...
**Dokumentace: kompletní. Kód: Tasky 1–3 plánu podprojektu 1 hotové** — Laravel 13 skeleton s vynucenými konvencemi, testovací helpery (`EloquentMatcher`, `CollectionMatcher`, `DataMatcher`, `spyLogger`) a security master (`instruments`, `instrument_symbols`, `SymbolResolver`). Tasky 4–23 nezačaté.
