...
**Dokumentace: kompletní. Kód: Tasky 1–4 plánu podprojektu 1 hotové** — Laravel 13 skeleton s vynucenými konvencemi, testovací helpery (`EloquentMatcher`, `CollectionMatcher`, `DataMatcher`, `spyLogger`), security master (`instruments`, `instrument_symbols`, `SymbolResolver`) a burzovní kalendář (`market_days`, `AlpacaCalendarSource`, `CalendarImporter`, `market-data:import-calendar`). Tasky 5–23 nezačaté.
